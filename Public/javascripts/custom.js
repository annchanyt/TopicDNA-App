...
$(document).ready(function() {
    ...
    if($(".content-inner.left-right-equal .row > div > div").length){
        $(".content-inner.left-right-equal .row > div > div").matchHeight();}

    if($(".document-collapse .tweets-panel > div").length){
...
function westernUnionResize ( $, window ) {
    ...
    window.watchResize(function(){
        ...
        if ( size > 3 ) {
            ...
            setTimeout(function(){ $('.map-location-marker').addClass('twinkle'); },1500);
        }
    });
} 
